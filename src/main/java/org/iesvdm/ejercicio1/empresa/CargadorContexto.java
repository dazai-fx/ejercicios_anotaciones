...
public class CargadorContexto {
    ...
    public static ArrayList<org.iesvdm.ejercicio1.empresa.Empleado> cargaContextoEmpresa() {

        org.iesvdm.ejercicio1.anotacion.Empleado[] empleadosAnotacion = Empresa.class.getAnnotationsByType(org.iesvdm.ejercicio1.anotacion.Empleado.class);

        ArrayList<org.iesvdm.ejercicio1.empresa.Empleado> listaEmpleados = new ArrayList<>();

        for (org.iesvdm.ejercicio1.anotacion.Empleado empleado: empleadosAnotacion){
